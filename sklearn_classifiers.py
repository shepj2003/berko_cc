...
####
#### uncomment the code below to examine different types of k-nearest -neighbour 
####
##names = ['knn1', 'knn2', 'knn3', 'knn4', 'knn5']
##classifiers = [
##    
...
####
#### uncomment the code below to test different types of support vector machine
####
##names = ['svc-linear', 'svc-rbf', 'svc-sigmoid']
##classifiers = [
##    SVC(kernel="linear", C=400),
##    SVC(kernel="rbf"),
##    SVC(kernel = "sigmoid")
##]
...
################################################################
#generate some slightly random data
################################################################
